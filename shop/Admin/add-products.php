    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="col-md-12">
          ...
          <input type="text" name="original_price"  placeholder="Enter Product Price.."  class="form-control" mb-2>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-12">
          <button type="submit" class="btn btn-primary" name="add-products-btn">Save </button>
      </div>
    </div>
    </form>
		</div>
