    ...
    <div class="col-md-12">
      ...
      <div class="card">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="slug" value="<?= $data['slug']  ?>"  placeholder="slug.."  class="form-control">
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
          ...
          <img src="../uploads/<?= $data['image']  ?>" width="90px" height= "90px">
        </div>
        <div class="col-md-12">
          <label for=""> Meta Title</label>
          <input type="text" name="meta_title" value="<?= $data['meta_title']  ?>"    placeholder="Enter meta_title.."  class="form-control">
        </div>
        <div class="col-md-12">
